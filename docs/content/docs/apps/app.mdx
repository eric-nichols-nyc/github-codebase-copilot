...
If you use the GitHub → database import in `apps/app`, the full pipeline (API, GitHub calls, upsert) is documented in [GitHub project import](/apps/project-import).
